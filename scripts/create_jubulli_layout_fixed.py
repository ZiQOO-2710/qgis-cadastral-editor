...
from qgis.core import (
    ...
    QgsLayoutItemPage, QgsLegendStyle
)
...
# 지도에 표시할 레이어 설정 (jubulli_categorized만)
map_item.setLayers([layer])
map_item.setKeepLayerSet(True)

# 레이어 범위로 설정
extent = layer.extent()
extent.scale(1.1)  # 10% 여유 공간
...
# jubulli_categorized만 추가
from qgis.core import QgsLayerTreeLayer
tree_layer = QgsLayerTreeLayer(layer)
root.addChildNode(tree_layer)
